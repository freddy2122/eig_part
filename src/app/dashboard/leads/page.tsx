...
export default function LeadsPage() {
  ...
  return (
    <div className="rounded-xl bg-white border border-slate-200 p-6">
      ...
      {loading ? (
        <div className="mt-6">
          <LoadingBlock label="Chargement de tes leads…" />
        </div>
      ) : (
        <>
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={(payload?.meta?.current_page ?? page) <= 1 || loading}
              >
                Précédent
              </button>
              <button
                ...
                disabled={(payload?.meta?.current_page ?? page) >= (payload?.meta?.last_page ?? 1) || loading}
              >
                Suivant
              </button>
            </div>
